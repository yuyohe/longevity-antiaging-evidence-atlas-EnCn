...
| 表 | 行数 | 用途 |
|---|---:|---|
| data/literature_library.csv | 16151 | 全量文献库，供飞书完整展示。 |
| data/core_review_queue.csv | 90 | A/B 级主题核心文献人工复核队列。 |
...
| data/methodology_appraisal_plan.csv | 90 | 给核心队列分配 AMSTAR 2 / RoB 2 / ROBINS-I / domain screen。 |

## 飞书同步目标表

| 飞书表 | table_id | 行数 |
|---|---|---:|
| 文献库全量 | tblphEOQSzMb3dFi | 16151 |
| 核心复核队列 | tblRyAJ5afGo6tGj | 90 |
| 主题评级说明 | tblMfLdNDc4zkrDk | 28 |
| PICO_PECO问题框架 | tblPJ2AHChIV7gGo | 29 |
| Claim级证据评级 | tblgsBeHJ7LI7uKf | 58 |
| 方法学复核计划 | tblwZVdgFQRYd1fA | 90 |
