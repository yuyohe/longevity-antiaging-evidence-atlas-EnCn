...
- Candidate ID: `clinicaltrials-NCT07218445`
...
EN: Metadata-level record for Caloric Restriction in Humans: The Effect of Tirzepatide on Menopausal Vasomotor Symptoms and Biological Aging in Post-menopausal Women With Obesity. Result extraction requires abstract or full-text retrieval.

ZH draft: 中文草稿：该记录属于「热量限制与人体衰老」主题；当前只有题录/注册信息，尚未抽取到摘要级结果，需要后续补全文或摘要。

## Conclusion Boundary / 结论边界

EN: Metadata-level candidate only; no result-level conclusion is available yet for Caloric Restriction in Humans.
