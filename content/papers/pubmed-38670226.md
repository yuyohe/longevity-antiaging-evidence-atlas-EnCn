...
- Candidate ID: `pubmed-38670226`
- Source: `PubMed`
- PMID: `38670226`
- PMCID: ``
- DOI: `10.1016/j.rceng.2024.04.012`
- Year: 2024
...
ZH draft: 中文草稿：该研究属于「Klotho / IL-11」主题；摘要/题录结果显示：The study encompassed a cohort of 10,265 participants. In fully adjusted models of multivariate logistic regression analysis, we identified a negative correlation between serum ln α-Klotho and OA (OR = 0.77, 95% CI: 0.65-0.91, p = 0.003). When stratifying serum α-Klotho levels into tertiles, individuals in the highest tertile exhibited a 26% reduced risk of OA compared to those in the lowest tertile (OR = 0.84, 95% CI: 0.73-0.97, p = 0.014). Subsequent analyses indicated a linearly negative a...

## Conclusion Boundary / 结论边界

EN: Serum α-Klotho levels exhibit a significant negative linear correlation with the prevalence of osteoarthritis in middle-aged and elderly populations in the United States.

ZH draft: 中文草稿：英文摘要结论为：Serum α-Klotho levels exhibit a significant negative linear correlation with the prevalence of osteoarthritis in middle-aged and elderly populations in the United States.
