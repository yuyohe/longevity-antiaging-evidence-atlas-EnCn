...
- Candidate ID: `pubmed-42622994`
- Source: `PubMed`
- PMID: `42622994`
- PMCID: ``
- DOI: `10.1007/s41999-026-01587-8`
- Year: 2026
...
EN: Of the 203 randomized participants, 119 (58.6%) completed the 12-month follow-up. Treatment-by-sarcopenia interactions were not statistically significant. Stratum-specific analyses suggested a pattern of greater functional improvement with FIRM than with conventional rehabilitation, particularly among participants with low HGS and, to a lesser extent, those with sarcopenia. In the fully adjusted models, FIRM was associated with greater improvement in independent ambulation among participants with low HGS (odds ratio, 4.25; risk difference, + 34.7%; P = 0.014).

ZH draft: 中文草稿：该研究属于「抗阻训练、肌肉与衰弱」主题；摘要/题录结果显示：Of the 203 randomized participants, 119 (58.6%) completed the 12-month follow-up. Treatment-by-sarcopenia interactions were not statistically significant. Stratum-specific analyses suggested a pattern of greater functional improvement with FIRM than with conventional rehabilitation, particularly among participants with low HGS and, to a lesser extent, those with sarcopenia. In the fully adjusted models, FIRM was associated with greater improvement in independent ambulation among participants...

## Conclusion Boundary / 结论边界

EN: Integrated rehabilitation may provide greater functional benefits than conventional rehabilitation in older adults with hip fractures, particularly among those with low muscle strength. However, given the lack of statistically significant interaction effects and the attenuation of the observed associations in the fully adjusted models, these findings should be interpreted as exploratory.

ZH draft: 中文草稿：英文摘要结论为：Integrated rehabilitation may provide greater functional benefits than conventional rehabilitation in older adults with hip fractures, particularly among those with low muscle strength. However, given the lack of statistically significant interaction effects and the attenuation of the observed associations in the fully adjusted models, these findings should be interpreted as exploratory.
