...
- Candidate ID: `clinicaltrials-NCT05485610`
...
EN: Metadata-level record for NAD/NMN/NR and Aging: Effect of NMN (Nicotinamide Mononucleotide) on Diminished Ovarian Reserve (Including Premature Ovarian Insufficiency). Result extraction requires abstract or full-text retrieval.
