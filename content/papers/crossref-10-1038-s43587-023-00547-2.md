...
- Candidate ID: `crossref-10.1038/s43587-023-00547-2`
- Source: `Crossref`
- PMID: ``
- PMCID: ``
- DOI: `10.1038/s43587-023-00547-2`
- Year: 2023
...
EN: Metadata-level record for Dietary Patterns and Longevity: Isoleucine dietary restriction boosts healthspan and longevity in mice. Result extraction requires abstract or full-text retrieval.
...
- ZH: 可支持：将「饮食模式与死亡风险」作为证据图谱中的候选主题，并按 D 级草判证据继续复核。
- EN: Supports treating Dietary Patterns and Longevity as a candidate evidence topic with draft level D, pending full review.
