...
- Candidate ID: `clinicaltrials-NCT03283085`
...
EN: Metadata-level record for NAD/NMN/NR and Aging: A Safety Extension Study of Ontamalimab in Participants With Moderate to Severe Ulcerative Colitis or Crohn's Disease (AIDA). Result extraction requires abstract or full-text retrieval.

ZH draft: 中文草稿：该记录属于「NAD/NMN/NR 与衰老」主题；当前只有题录/注册信息，尚未抽取到摘要级结果，需要后续补全文或摘要。

## Conclusion Boundary / 结论边界

EN: Metadata-level candidate only; no result-level conclusion is available yet for NAD/NMN/NR and Aging.
