...
- Candidate ID: `clinicaltrials-NCT05678426`
- Source: `ClinicalTrials.gov`
- PMID: ``
- PMCID: ``
- DOI: ``
- Year: 2021
- Journal/Registry: ClinicalTrials.gov
- Topic: 限时进食与代谢健康 / Time-Restricted Eating and Metabolic Health
- Evidence source depth: `metadata_only`

## Study Design / 研究设计

- Draft study type: `registered_clinical_trial`
...
EN: Metadata-level record for Time-Restricted Eating and Metabolic Health: TirolGESUND: Baseline-controlled Comparison of the Effects of Fasting Dietary Intervention or Smoking Cessation Combined With Exercise in Healthy Female Tyrolean Volunteers Aged 30-60 on Epigenetic and Multi-omic Biomarkers of Health, Ageing, and Disease. Result extraction requires abstract or full-text retrieval.

ZH draft: 中文草稿：该记录属于「限时进食与代谢健康」主题；当前只有题录/注册信息，尚未抽取到摘要级结果，需要后续补全文或摘要。

## Conclusion Boundary / 结论边界

EN: Metadata-level candidate only; no result-level conclusion is available yet for Time-Restricted Eating and Metabolic Health.
...
- Authority signal: trial registry; peer-reviewed journal metadata; metadata_only
