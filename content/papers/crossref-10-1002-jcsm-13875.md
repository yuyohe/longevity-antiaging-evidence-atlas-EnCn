# Correction to “Effectiveness of Mind–Body Exercise in Older Adults With Sarcopenia and Frailty: A Systematic Review and Meta‐Analysis”
...
- Candidate ID: `crossref-10.1002/jcsm.13875`
- Source: `Crossref`
- PMID: ``
- PMCID: ``
- DOI: `10.1002/jcsm.13875`
- Year: 2025
...
EN: Metadata-level record for Resistance Training, Muscle, and Frailty: Correction to “Effectiveness of Mind–Body Exercise in Older Adults With Sarcopenia and Frailty: A Systematic Review and Meta‐Analysis”. Result extraction requires abstract or full-text retrieval.

ZH draft: 中文草稿：该记录属于「抗阻训练、肌肉与衰弱」主题；当前只有题录/注册信息，尚未抽取到摘要级结果，需要后续补全文或摘要。

## Conclusion Boundary / 结论边界

EN: Metadata-level candidate only; no result-level conclusion is available yet for Resistance Training, Muscle, and Frailty.
