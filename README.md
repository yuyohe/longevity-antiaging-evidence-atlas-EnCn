...
**Current snapshot / 当前公开快照:** 2026-08-28<br>
**Maintainer and public brand / 维护方与公开品牌:** 宇多Yul细胞/yulcell<br>
**Repository / 仓库:** `longevity-antiaging-evidence-atlas-EnCn`

> **End-August curated update / 8 月底精编说明:** [plain-language guide / 普通读者说明](content/public-reader/end-august-2026-update.md)<br>
> **Self-contained report / 自包含图文报告:** [open report / 打开报告](docs/end-august-public-update-2026-08.html)<br>
> **Posting asset dashboard / 发帖资产面板:** [open dashboard / 打开面板](docs/yulcell-posting-asset-dashboard-2026-08-28.html)<br>
...
| --- | ---: | --- |
| Candidate sources / 候选来源 | 11,104 | Search index awaiting review / 等待复核的资料目录 |
| Shortlist / 入选短名单 | 3,039 | Direct topic matches prioritized for review / 与主题直接相关的优先复核记录 |
| Evidence findings / 证据发现 | 3,039 | Automated drafts, not completed full-text reviews / 自动整理草稿，不等于全文复核完成 |
| Evidence matrix / 证据矩阵 | 1,500 | Bounded comparison layer / 有容量上限的比较层 |
| Public CSV processing rows / 五层 CSV 总行数 | 29,786 | A paper may occur in several layers / 同一论文可跨层出现 |
| Paper cards / 论文卡片 | 3,039 | One page per active finding / 每条当前 finding 一页 |
...
The 29,786-row total is the sum of five processing layers. It is not a count of unique papers.

29,786 行是五张处理层表的行数相加，不是互不重复的论文数。

## Why Counts Stay Bounded / 为什么体量保持受控

This release searched PubMed from 2026-08-10 through 2026-08-28, found 923 unique matches, and identified 911 new candidates. After topic checks, deduplication, and capacity controls, candidates changed from 11,079 to 11,104 and findings from 2,966 to 3,039. Full topics primarily replace lower-priority records; under-cap topics add only suitable records.

本轮补检 2026-08-10 至 2026-08-28 的 PubMed 文献，得到 923 个唯一匹配，其中 911 条是新候选。经过主题核对、去重和容量控制，候选由 11,079 条调整为 11,104 条，findings 由 2,966 条调整为 3,039 条；已满额主题以替换为主，未满额主题只补入合格记录。
...
- **English:** 248 recent candidates remain active; 162 entered the findings layer after topic and quality guards.
- **中文：** 近期候选最终保留 248 条，其中 162 条通过主题与质量防线进入 findings。
...
- **English:** All 3,039 finding PMIDs were checked against official NCBI summaries; missing summaries and substantive title mismatches are both zero.
- **中文：** 用 NCBI 官方摘要核对全部 3,039 个 finding PMID；摘要缺失和实质题名冲突均为 0。
...
1. [End-August update / 8 月底精编说明](content/public-reader/end-august-2026-update.md)
...
- [Self-contained August report / 8 月自包含报告](docs/end-august-public-update-2026-08.html)
- [Posting asset dashboard / 发帖资产面板](docs/yulcell-posting-asset-dashboard-2026-08-28.html)
...
The July CSV snapshot remains unpacked for direct comparison. May, June, and the complete mid-August five-table snapshot are verified ZIP archives under [`archive/public-data/`](archive/public-data/). Git history remains the final recovery path.

7 月 CSV 保持展开，便于直接比较；5 月、6 月和完整的 8 月中期五表快照已压缩并校验，位于 [`archive/public-data/`](archive/public-data/)。Git 历史仍是最终恢复路径。
